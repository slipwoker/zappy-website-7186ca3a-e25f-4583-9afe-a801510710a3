    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "נופר כוהנה - אימון מנטלי ונומרולוגיה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '7186ca3a-e25f-4583-9afe-a801510710a3',
                    name: data.name || '',
                    email: data.email || '',
